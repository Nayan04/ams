...
<head>
<meta charset="UTF-8">
<title>Year Details <?php echo date('d-m-Y'); ?></title>
<?php 
///////////////////////////
$module=17;                //
      ...
      <div class="box box-default" style="background:rgba(254,254,254,1);">
        <div class="box-header with-border">
          ...
          <?php }else{
			   ...
			   $per_val=$obj_p->get_access_of_usser_by($user,$module,$column);
				if($per_val){?>
           <a class="btn btn-app" onClick="del_year();" id="dele_row"> <i class="fa fa-scissors"></i>Delete </a>
           <?php }else{
                   echo $del_str;
                }?>
               <!------------------------------------------------------------------------------------------->
        ...
        <div class=" xls">
          ...
          <table id="example1" class="table table-bordered table-striped" width="100%" >
            ...
            <td colspan="6" align="center"><strong>Office of Commissioner of Income Tax (Audit), Ahmedabad</strong></td>
             ...
             <tr>
             <th></th>
              <td colspan="6" align="center"><strong>List of Year</strong></td>
             </tr>
              <tr>
            ...
            <form id="cit_v">
             ...
             <?php include("../model/year_db.php");
		         ...
		         $r=$obj->view_year();
				           $sno=0;
		 		 while($cit=mysql_fetch_array($r)){
			?>
              <tr>
              <td style="display:none;"><input type="radio"  name="che" value="<?=$cit['year_id'];?>" ></td>
