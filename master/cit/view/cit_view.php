...
<head>
<meta charset="UTF-8">
<title>CIT Details <?php echo  date('d-m-Y'); ?></title>
<!-------------------- HEADER MENUS---------------------------->
<?php ///////////////////////////
$module=7;                //
      ...
      <div class="box box-default" style="background:rgba(254,254,254,1);">
        <div class="box-header with-border">
          ...
          <?php $module=7;
           ...
           <a class="btn btn-app" onClick="del_cit();" id="dele_row"> <i class="fa fa-scissors"></i>Delete </a>
           <?php }else{
                   echo $del_str;
                }?>
               <!------------------------------------------------------------------------------------------->
        ...
        <div class="box box-body xls">
          ...
          <table id="example1" class="table table-bordered table-striped " width="100%" >
            ...
            <td colspan="4" align="center"><strong>Office of Commissioner of Income Tax (Audit), Ahmedabad</strong></td>
             ...
             <tr>
             <th></th>
              <td colspan="4" align="center"><strong>List of CIT Charge</strong></td>
             </tr>
              <tr>
                <th></th>
                <th>SNo</th>
...
<script>$(function() {$("#excel ,#excel2").on('click', function(){$(".xls").table2excel({exclude: ".noExl",name: "Excel Document Name",filename: "CIT Charge"});}); });</script>
