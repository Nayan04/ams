...
<head>
<meta charset="UTF-8">
<title>City Detail <?php echo date('d-m-Y'); ?></title>
         ...
         <div>
          <table id="example1" class="table table-bordered table-striped xls" width="100%" >
           ...
           <td colspan="6" align="center"><strong>Office of Commissioner of Income Tax (Audit), Ahmedabad</strong></td>
            ...
            <tr>
            <th></th>
              <td colspan="6" align="center"><strong>List of City</strong></td>
             </tr>
           <tr>
           <th></th>
            <th>SNO</th>
           ...
           <tbody>
			...
			?>
              <tr>
              <td><input type="radio"  name="che" value="<?=$sec['city_id'];?>" ></td>
                <td><?php echo $sno= $sno +1 ;?></td>
                <td><?=$sec['name'];?></td>
                 <td><?=$sec['short_name'];?></td>
                  <td><?=$sec['city_group'];?></td>
                   <td><?=$sec['state'];?></td>
