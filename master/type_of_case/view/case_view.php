...
<head>
<meta charset="UTF-8">
<title>Case Details <?php echo date('d-m-Y'); ?></title>
  <?php 
///////////////////////////
$module=14;                //
      ...
      <div class="box box-default" style="background:rgba(254,254,254,1);">
        <div class="box-header with-border">
          ...
          <a class="btn btn-app"  onClick="edit();" id="edis"> <i class="fa fa-edit"></i> Edit </a>
           ...
           <a class="btn btn-app" onClick="del_case();" id="dele_row"> <i class="fa fa-scissors"></i>Delete </a>
           <?php }else{
                   echo $del_str;
                }?>
               <!-------------------------------------------------------------------------------------------> 
     ...
     <div class="xls">
          <table id="example1" class="table table-bordered table-striped" width="100%" >
             <thead>
              <tr>
            <th></th>
            <th colspan="6" align="center"><strong>Office of Commissioner of Income Tax (Audit), Ahmedabad</strong></th>
             </tr>
             <tr>
             <th></th>
              <th colspan="6" align="center"><strong>List Of Type of Cases</strong></th>
             </tr>
              <tr>
              <th></th>
                <th>SNO</th>
...
<script>$(function() {$("#excel").on('click', function(){$(".xls").table2excel({exclude: ".noExl",name: "Excel Document Name",filename: "Type Of Case Detail"});}); });</script>
