    ...
    <div class="container-fluid">
      ...
      <div class="box box-default" style="background:rgba(254,254,254,1);">
        <div class="box-header with-border">
          ...
          <a class="btn btn-app" onClick="add_ao();"> <i class="fa fa-save"></i> Save </a> 
      ...
      <div class="box box-primary" style="width:40%; margin-left:30%; margin-right:20%;">
        <div class="box-body">
          ...
          <div class="form-group">
           ...
           <label for="code" class="control-label">Assessing  Officer</label><div id="err" style="margin:2px;"></div>
            <input type="text" name="ao"  class="form-control" id="ao" placeholder="Assessing Officer Name"  autofocus/>
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="add_ao();" id="save" >Submit</button>
      </div>
        </div>
