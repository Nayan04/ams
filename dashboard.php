...
<?php }else{?>
<script>alert("Unauthorised User ");
document.location="login/views/index.php";</script>
<?php } ?>
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <!-------------------------------------------------------------------------------------------->
          ...
          <form class="navbar-form navbar-left" role="search">
            <div class="form-group" style="color:#FFF; text-transform:capitalize; text-decoration:underline; padding-top:5px;">
      <?php echo "Welcome  ". $_SESSION['user_id'] ." To Audit Monitoring System"; ?>
            </div>
          </form>
