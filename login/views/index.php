...
<!-- Font Awesome Icons -->
<link href="../../assests/dist/css/font.css" rel="stylesheet" type="text/css" />
<!-- Theme style -->
<link href="../../assests/dist/css/AdminLTE.css" rel="stylesheet" type="text/css" />
<!-- iCheck -->
<link href="../../assests/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
...
<div class="login-box">
<!--div class="login-logo"> <a href="">Aduit Monitoring System</b></a> </div-->
<!-- /.login-logo -->
<div class="login-box-body" >
  <p class="login-box-msg"><b>Welcome to Audit Monitoring System</b></p>
  <div id="errorMessage"></div>
  <form  method="post">
    <div class="form-group has-feedback">
      <input type="text" name="user" id="user" class="form-control" placeholder="User Id" autofocus/>
    ...
    <div class="row">
      <!-- /.col -->
      <div class="col-xs-4">
        <button type="button" class="btn btn-primary btn-block btn-flat" onClick="validLogin()">Login</button>
      </div>
      <!-- /.col -->
    </div>
  </form>
...
<!-- iCheck -->
<script src="../../assests/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
