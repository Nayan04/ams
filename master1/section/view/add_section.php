...
<!-------------------- HEADER MENUS---------------------------->
            <?php session_start(); ?><li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Navigation<span class="caret"></span></a>
    ...
    <div class="container-fluid">
      ...
      <div class="box box-default" style="background:rgba(254,254,254,1);">
        <div class="box-header with-border">
          ...
          <a class="btn btn-app" onClick="add_section();"> <i class="fa fa-save"></i> Save </a> 
      ...
      <div class="box box-primary" style="width:40%; margin-left:30%; margin-right:20%;">
        <div class="box-body">
             <form class="modal-content" id="myform">
              ...
              <div class="form-group">
            <label for="code" class="control-label">SECTION</label><div id="err"></div>
        ...
        <textarea name="descrip"  class="form-control" id="descrip" placeholder="Enter Description"></textarea>
         ...
         <div class="form-group">
                    ...
                    <label>Last Date Of Action</label>
                  
                    <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <input type="text" id="dat" name="dat" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="add_section();" id="save" >Submit</button>
      </div>
        </div>
