      ...
      <div class="box box-primary" style="width:40%; margin-left:30%; margin-right:20%;">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="cit"  class="form-control" id="cit" placeholder="Enter CIIT Charge...">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="add_cit();" >Send message</button>
      </div>
        </div>
