    ...
    <div class="container-fluid">
      ...
      <div class="box box-default" style="background:rgba(254,254,254,1);">
        <div class="box-header with-border">
          ...
          <a class="btn btn-app" onClick="add_case();"> <i class="fa fa-save"></i> Save </a> 
      ...
      <div class="box box-primary" style="width:40%; margin-left:30%; margin-right:20%;">
        <div class="box-body">
             <form class="modal-content" id="myform">
              ...
              <div class="form-group">
            <label for="case" class="control-label">Case</label><div id="err"></div>
            <input type="text" name="case"  class="form-control" id="case" placeholder="Enter Case" autofocus>
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="add_case();" id="save">Submit</button>
      </div>
        </div>
