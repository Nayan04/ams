...
<head>
<meta charset="UTF-8">
<title>Audit Party Type <?php echo date('d-m-Y'); ?></title>
<!-------------------- HEADER MENUS---------------------------->
<?php ///////////////////////////
$module=8;                //
        ...
        <div class="box-header with-border">
          ...
          <a class="btn btn-app"  onClick="edit()" id="edis"> <i class="fa fa-edit"></i> Edit </a>
           <?php }else{
			   ...
			   $per_val=$obj_p->get_access_of_usser_by($user,$module,$column);
				if($per_val){?>
           <a class="btn btn-app" onClick="del_apt()" id="dele_row"> <i class="fa fa-scissors"></i>Delete </a>
            <?php }else{
                   echo $del_str;
                }?>
               <!------------------------------------------------------------------------------------------->           
          <a class="btn btn-app" style="color:#E9E9E9"> <i class="fa fa-save"></i> Save </a>            
        ...
        <div id="#re"></div>
          ...
          <table id="example1" class="table table-bordered table-striped xls" width="100%" >
            ...
            <td colspan="6" align="center"><strong>Office of Commissioner of Income Tax (Audit), Ahmedabad</strong></td>
             ...
             <tr>
             <th></th>
              <td colspan="6" align="center"><strong>List of Audit Party Type</strong></td>
             </tr>
