    ...
    <div class="container-fluid">
     ...
     <div class="box box-default" style="background:rgba(254,254,254,1);">
        <div class="box-header with-border">
          ...
          <a class="btn btn-app" onClick="update_user();"> <i class="fa fa-save"></i> Save </a> 
      ...
      <div class="box box-primary" style="width:40%; margin-left:30%; margin-right:20%;">
        <div class="box-body">
          ...
          <div class="form-group">
           ...
           <label for="name" class="control-label">User</label>
            ...
            <input type="text" name="user"  class="form-control" id="user" value="<?php echo $cit['user']; ?>">
         </div> <!-- /.input group -->
         <div class="form-group">
             
           <label for="name" class="control-label">Password</label>
           
            <input type="password" name="Pass"  class="form-control" id="pass" value="<?php echo $cit['password']; ?>">
         </div>
           <div class="form-group">
        ...
        <button type="button" id="save" class="btn btn-primary" data-dismiss="modal" onClick="update_user();" >Update</button>
      </div>
        </div>
        <?php } ?>
        <!-- /.box-body -->
