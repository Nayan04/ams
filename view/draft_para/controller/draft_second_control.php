...
$obj_db->update_draft($dpno,$dor ,$year,$dosparta,$assname ,$panno,$dore,$dode ,$dofrd,$stat,$gist,$aom,$cit,$ccit,$range_id,$accepted,$expofres,$sno);

  $uid=$_REQUEST['uid'];

$obj_db->update_dpdet($ay,$te,$bfd,$board_date,$rem ,$com_date,$ref,$col ,$file1,$file2,$ba,$ini,$sec,$countt,$uid,$block_p);
