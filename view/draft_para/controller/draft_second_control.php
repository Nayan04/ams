...
if($apcode['total']==0){
	$APMastCode=1;/// isko sahi logic laga kar krana hai
	}else{
		if($APCode==$apcode['APCode']){}else{
		$APMastCode=$apcode['total']+1;}
		}

$obj_db->update_draft($dpno,$dor ,$year,$dosparta,$assname ,$panno,$dore,$dode ,$dofrd,$stat,$gist,$aom,$cit,$ccit,$range_id,$accepted,$expofres,$sno, $APCode, $APMastCode, $user);

  $uid=$_REQUEST['uid'];

$obj_db->update_dpdet($ay,$te,$bfd,$board_date,$rem ,$com_date,$ref,$col ,$file1,$file2,$ba,$ini,$sec1,$countt,$uid,$block_p, $APCode, $APMastCode);
