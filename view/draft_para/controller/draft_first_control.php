	 ...
	 && in_array($file_extension, $validextensions))
		...
		if ($_FILES["att1"]["error"] > 0)
			...
			if (file_exists("../../../docs/" . $_FILES["att1"]["name"]))
				{ $sourcePath = $_FILES['att1']['tmp_name']; 
$num=time();
...
$obj_db->insert_draft($dpno, $dor, $year, $dosparta, $assname, $panno, $dore, $dode, $dofrd, $stat, $gist, $aom, $cit, $ccit, $range_id, $accepted, $expofres, $countt, $APMastCode, $APCode, $user);
$obj_db->insert_dpdet($ay, $te, $bfd, $board_date, $rem, $com_date, $ref, $col, $file1, $file2, $ba, $ini, $sec1, $countt, $block_p, $APMastCode, $APCode);
?>
