...
<table id="example1" class="table table-bordered table-striped display xlss"  style="white-space:nowrap;">
  ...
  <thead>
  <tr><th colspan="12" style="table-layout:auto; text-align:center; font-family:Tahoma, Geneva, sans-serif; font-size:14px; color:#000">
  Office Of Commissioner Of Income Tax (Audit), Ahemdabad</th></tr>
  <tr>
  <th colspan="12" style="table-layout:auto; text-align:center; font-family:Tahoma, Geneva, sans-serif; font-size:13px; color:#000"> List Of Allocated Auditable Cases</th>
  </tr>
    <tr>
      <th>SN</th>
      <th>Assessee Name</th>
