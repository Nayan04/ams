            ...
            <div style="width:80%; height:100%; background-color:#fff; float:left;">
              <form name="auditable_case" id="auditable_case">
                <table width="100%" id="example2" class="table table-bordered table-striped display" style="white-space:nowrap;">
                  ...
                  <tr>
                    <td colspan="4" class="infoaa"><input type="button" value="View" id="get_view" name="get_view" onClick="views_auditable()" class="btn btn-success">
                      <input type="button" value="Excel" id="excel1" name="excel"  class="btn btn-success"></td>
                    <td ></td>
                  </tr>
                </table>
              </form>
