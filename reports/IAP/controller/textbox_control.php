...
if($id=='lar')
{
	 ...
	 if($date=="between"){?>
      <tr>
           <td><input type="text" id="dos_sd" name="dos_sd" value="" placeholder='dd/mm/yyyy' />
                Between
	 ...
	 if($date=="between"){?>
      <tr>
           <td><input type="text" id="tax_st" name="tax_st" placeholder='dd/mm/yyyy' />
                Between
            <input type="text" id="tax_end" name="tax_end" placeholder='dd/mm/yyyy' /></td>
     <?php }else if($date=="equal" || $date=="greater"||$date=="less")
          {	?>
          <input type="text" id="tax_st" name="tax_st" placeholder='dd/mm/yyyy' />
           <?php
          }
