...
if($id=='lar')
{
      ...
      <tr>
           ...
           <span class="textfieldRequiredMsg">*required</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span>
                ...
                <input type="text" id="sd" name="sd" size="10" placeholder='dd/mm/yyyy' />
	 ...
	 if($date=="between"){?>
      <tr>
           ...
           <input type="text" id="dos_sd2" name="dos_sd2" value="" placeholder='dd/mm/yyyy' />
           <span class="textfieldRequiredMsg">*required</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span>
                Between
...
//-->
        ...
        <script type="text/javascript">
<!--
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "date", {format:"dd/mm/yyyy", validateOn:["blur", "change"], useCharacterMasking:true});
//-->
      </script>
        <script type="text/javascript">
<!--
var sprytextfield4 = new Spry.Widget.ValidationTextField("sprytextfield4", "date", {format:"dd/mm/yyyy", validateOn:["blur", "change"], useCharacterMasking:true});
//-->
      </script>
        <script type="text/javascript">
<!--
...
<!--$("#tax_st").keypress(function(a) {
 return 8 == a.which || 0 == a.which || 46 == a.which && -1 == $("#te").val().indexOf(".") || !(a.which < 48 || a.which > 57) ? ($("#errmsg1").hide(), 0) : ($("#errmsg1").html("Enter Only Digits With one desimal point").show(1000), !1)
});
...
var sprytextfield9 = new Spry.Widget.ValidationTextField("sprytextfield9", "date", {format:"dd/mm/yyyy", validateOn:["blur", "change"], useCharacterMasking:true});
//-->
      </script>
