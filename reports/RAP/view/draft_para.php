      ...
      <div class="box-header with-border">
        ...
        <?php $module=20;
            ...
            <?php }else{
               ...
               <!------------------------------------------------------------------------------------------->
         <a id="for_exit" onClick="exit()" class="btn btn-app"> <i class="fa fa-sign-out"></i> Exit </a> </h3>
        </h3>
      </div>
      <div class="box-body">
        <div class="container" style="width:100%;">
          <div  style="min-height:5px;  background:rgb(60,141,188);padding:5px;width:100%; margin:5px;color:#FFF;"> Select Report </div>
          <div style="width:100%; height:100%; background-color:#CCC; float:left; margin:5px;  border:1px solid #030303;">
            <!--main container-->
            <div style="width:20%; height:100%; background-color:#fff; float:left; border-right:1px solid #030303;border-bottom::2px solid #030303; ">
              <!--side bar-->
              <table width="100%" class="table table-bordered table-striped display">
                <thead>
                <th>SNo</th>
                  <th>REPORT NAME</th>
                  </thead>
                ...
                <tr>
                  <td>3</td>
                  <td style="background-color:#039;"><a href="draft_para.php"><font color="#FFFFFF">Draft Para</font></a></td>
                </tr>
                <tr>
                  <td>4</td>
            ...
            <div style="width:80%; height:100%; background-color:#fff; float:left;">
              <form id="draft_report" name="draft_report">
                <table width="100%" id="example1" class="table table-bordered table-striped display" style="white-space:nowrap;">
                  ...
                  <tr>
                    <td>C & AG Year</td>
                    <td colspan="2"><select  id="cay" name="cay" onChange="">
                        <option value="...">ALL</option>
                        <?php 
                  ...
                  <tr>
                    <td> Asst. Year </td>
                    <td colspan="2"><select  id="ay" name="ay" onChange="">
                        <option value="...">ALL</option>
                        <?php 
                  ...
                  <tr>
                    <td colspan="2"><input type="button" value="View" id="get_view" name="get_view" onClick="views_report()" class="btn btn-success">
           ...
           <div style="margin-top:10px; width:100%;" id="draft_table" class="xl"> </div>
              <!-- /.end of main bar -->
