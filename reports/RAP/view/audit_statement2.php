...
<div class="wrapper">
            ...
            <div style="width:100%; height:100%; background-color:#CCC; float:left; margin:5px;"><!--main container-->
              ...
              <div style="width:20%; height:100%; background-color:#fff; float:left; "><!--side bar-->
               ...
               <thead>
                  ...
                  <tr>
                    <td>2</td>
                    <td  style="background-color:#039;"><a href="audit_statement2.php"><font color="#FFFFFF">Audit Statement No.2</font></a></td>
                  </tr>
                  <tr>
                    <td>3</td>
  ...
  <tr>
   ...
   <td>Quater</td>
    ...
    <option value="1st Quater">1st Quater</option>
    <option value="2nd Quater">2nd Quater</option>
    <option value="3rd Quater">3rd Quater</option>
    <option value="4th Quater">4th Quater</option>
 ...
 <tr>
        <td colspan="5">
        <input type="button" value="View" id="get_view" name="get_view" onClick="views()" class="btn btn-success">
          <input type="button" value="Excel" id="excel" name="excel"  class="btn btn-success"></td>
            ...
            <div style=" border:1px solid; width:100%;" id="audit2_table" class="xl"> 
...
$(document.ready
    ...
    <script src="../../IAP/view/report_js.js"></script>
