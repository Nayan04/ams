      <table id="example1" class="table table-bordered table-striped display year_filter" style="text-transform:capitalize;" >
                  <thead>
              ...
              <tr>
                ...
                <td colspan="12" align="center"><strong>Summary Audit Party Wise (IAP) </strong></td>
              </tr>
                    <tr>
